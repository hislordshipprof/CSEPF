                                ...
                                <div className="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                                    <div className="single-footer-widget">
                                        <div className="widget-head">
                                            ...
                                            <p style={{fontSize: 21,color:'white',fontWeight: "bold",marginRight:10}}>CSEPF</p>
...
<img src="/assets/img/logonew1-1.jpg" style={{ width:120, height: 50 }} alt="logo-img" />
                                        ...
                                        <div className="footer-content">
                                            <p>
                                               Colorado Science and Engineering Policy Fellowship where we train young STEM professionals to be excellent in policy making.
                                            </p>
                    ...
                    <div className="container">
                        <div className="footer-wrapper d-flex align-items-center justify-content-between">
                            <p className="wow fadeInLeft color-2" data-wow-delay=".3s">
                                © All Copyright {new Date().getFullYear()} by <Link href="/">CSEPF</Link>
                            </p>
