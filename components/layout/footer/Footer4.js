          ...
          <div className="footer-widgets-wrapper pb-0 pt-0">
            <div className="footer-style-2">
              <div className="row ">
                ...
                >
                  <div className="single-footer-widget">
                    ...
                    <div className="footer-content">
                      <p>
                        Colorado Science and Engineering Policy Fellowship where
                        we train young STEM professionals to be excellent in
                        policy making.
                      </p>
                ...
                <div
                  className="col-xl-4 col-lg-4 col-md-6 ps-lg-4 wow fadeInUp"
                  data-wow-delay=".5s"
                >
