                      ...
                      <div className="post-content">
                        ...
                        <div className="hilight-text mt-4 mb-4">
                          <p>
                            ...
                            sapien neque lobortis tortor, quis efficitur mi
                            ipsum eu metus. Praesent eleifend orci sit amet est
                            vehicula.
                          </p>
                          <svg
                            width={36}
                        ...
                        <p className="mt-4 mb-5">
                          ...
                          erat placerat. In iaculis arcu eros.
                        </p>
                        ...
                        <p className="pt-5">
                          ...
                          exercitation ullamco laboris nisi ut aliquip ex ea
                          dolor commodo consequat. Duis aute irure and dolor in
                          reprehenderit.Consectetur adipisicing elit, sed do
                          eiusmod tempor incididunt ut labore et dolore of magna
                          aliqua. Ut enim ad minim veniam, made of owl the quis
                          nostrud exercitation ullamco laboris nisi ut aliquip
                          ex ea dolor commodo consequat. Duis aute irure and
                    ...
                    <div className="comments-area">
                      ...
                      <div className="blog-single-comment d-flex gap-4 pt-4 pb-5">
                        ...
                        <div className="content">
                          ...
                          <Link href="/events-details" className="reply">
                            Reply
                          </Link>
                        </div>
                      </div>
                      <div className="blog-single-comment d-flex gap-4 pt-5 pb-5">
                        ...
                        <div className="content">
                          <div className="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                            <div className="con">
                              <h5>
                                <Link href="/events-details">Alex Flores</Link>
                              </h5>
                              <span>March 20, 2024 at 2:37 pm</span>
                            </div>
                            <div className="star">
                    ...
                    <div className="single-sidebar-widget">
                      ...
                      <div className="news-widget-categories">
                        <ul>
                          ...
                          <li>
                            <Link href="/events-details">IT Consultancy</Link>{" "}
                            <span>(11)</span>
                          </li>
                          <li className="active">
                            <Link href="/events-details">App Development</Link>
                            <span>(12)</span>
                          </li>
                          <li>
                            <Link href="/events-details">UI/UX Design</Link>{" "}
                            <span>(18)</span>
                          </li>
                          <li>
                            <Link href="/events-details">Cyber Security</Link>{" "}
                            <span>(07)</span>
                          </li>
                        </ul>
                      </div>
