...
export default function Team() {
    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={2} breadcrumbTitle="Our Staff Members">
                <section className="team-section-4 section-padding">
                    <div className="container">
                        <div className="row g-4">
                       
                           {staff_members.map((data)=>( <div className="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                                <div className="team-card-items mt-0">
                                    <div className="team-image">
                                        <img src={data.img} alt="team-img" style={{width:430,height:400,objectFit:"contain"}}/>
