...
export default function Apply() {
    ...
    <path d="M5 10.5L8 13.5L15 6" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                    ...
                                                    <div className="content">
                                                        <p>The 2024 Fellowship is scheduled to run from late June to early August. Fellows are expected to be at the Capitol full-time Monday through Friday (approximately 40 hour weeks) and will receive a $4,000 stipend for the summer.</p>
                                    ...
                                    <div className="col-lg-6">
                                        <div className="contact-content">
                                            ...
                                            <p>
                                               Excited about joining the next cohort? Fill out the form below to get your application processed!. We cant wait to have you!
                                            </p>
