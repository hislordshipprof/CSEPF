                  ...
                  <div className="col-lg-6">
                    <div className="about-image-items">
                      ...
                      <div
                        ...
                        data-wow-delay=".3s"
                        style={{
                          backgroundImage: 'url("assets/img/about/03.png")',
                        }}
                      >
                        <div
                  ...
                  <div className="col-lg-6 mt-4 mt-lg-0">
                    <div className="about-content">
                      ...
                      <p
                        ...
                        data-wow-delay=".5s"
                      >
                        The Colorado Science and Engineering Policy Fellowship
                        is a first of its kind program in Colorado. The program
                        was co-founded by State Senator Chris Hansen (D-Denver)
                        and State Senator Bob Rankin (R-Carbondale) in 2018,
                        when the two legislators found common ground in being
                        policy-makers with backgrounds in engineering. With
                        Senator Rankin’s retirement in 2022, State Senator
                        Cleave Simpson (R-Alamosa) has stepped up to co-lead the
                        fellowship with Senator Hansen. Overall, the fellowship
                        is designed to give policy-making experience to
                        undergraduate and graduate students with backgrounds in
                        science, technology, engineering, and mathematics
                        (STEM), with the goal of increasing the presence of
                        individuals in public policy that come from a science
                      ...
                      <div className="about-icon-items">
                        ...
                        >
                          ...
                          <div className="content">
                            ...
                            <p>
                              Give Engineers the ability to solve <br />{" "}
                              problems using policy making
                            </p>
                          </div>
                        </div>
                        <div
            ...
            <div className="container">
              <div className="section-title text-center">
                ...
                <h2 className="text-white wow fadeInUp" data-wow-delay=".3s">
                  Enhancing Policy Ideas <br /> for the{" "}
                ...
                >
                  <div className="offer-items">
                    ...
                    <div className="icon">
                      ...
                      >
                        <path
                          d="M50,0 Q75,50 50,150 Q25,50 50,0Z"
                ...
                >
                  <div className="offer-items active">
                    ...
                    <div className="icon">
                      ...
                      >
                        <polygon
                          points="30,0 45,37.5 30,37.5 45,90 15,52.5 30,52.5 15,0"
                          fill="yellow"
                        />
                      </svg>
                    </div>
                            ...
                            {data?.socials?.map((social, index) => (
                              <li key={index.id}>
                                <Link href={social.url}>
                                  <i className={getIcon(social.name)} />
                                </Link>
                              </li>
                            ))}
                          </ul>
